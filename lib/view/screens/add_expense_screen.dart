...
class _AddExpenseScreenState extends State<AddExpenseScreen> {
  ...
  void _saveTransaction() async {
    ...
    final selectedCatData = _currentCategories.firstWhere(
          (cat) => cat['name'] == _selectedCategory,
      orElse: () => _currentCategories.first,
    );

    final transaction = TransactionModel(
      title: _notesController.text.trim().isNotEmpty
          ? _notesController.text.trim()
          : _selectedCategory,
      date: _selectedDate,
      amount: amount,
      iconPath: selectedCatData['icon'],
      isIncome: !_isExpense,
        ...
        children: [
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: Text(
                  "Expense",
                  style: TextStyle(
                    color: _isExpense ? AppColors.white : AppColors.textMuted,
                    fontWeight: FontWeight.bold,
                  ),
                ),
              ),
          ...
          Expanded(
            child: GestureDetector(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: !_isExpense ? AppColors.white : Colors.transparent,
                  borderRadius: BorderRadius.circular(25),
                  boxShadow: !_isExpense
                      ? [
                    const BoxShadow(
                ...
                child: Text(
                  "Income",
                  style: TextStyle(
                    color: !_isExpense ? AppColors.primary : AppColors.textMuted,
                    fontWeight: FontWeight.bold,
                  ),
                ),
              ),
  ...
  Widget _buildTextField({
    ...
    return Container(
      ...
      child: TextField(
        ...
        style: const TextStyle(
            fontSize: 15, color: AppColors.textMain, fontWeight: FontWeight.w600),
